...
"""
_DESCRIPTION = """\
https://github.com/brigs1/recustom_1/
"""
...
class recustom_1(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        return datasets.DatasetInfo(
            ...
            homepage="https://github.com/brigs1/recustom_1",
            citation=_CITATION,
        )

    def _split_generators(self, dl_manager):
        """Returns SplitGenerators."""
        downloaded_file = dl_manager.download_and_extract("/home/y/Documents/Jupyter_tests/datasets/recustom_1/dataset.zip")
        return [
